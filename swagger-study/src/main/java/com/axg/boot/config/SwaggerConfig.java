...
public class SwaggerConfig {
	...
	public static String CONTROLLER_URL="com.axg.boot.controller";    //Swagger扫描的接口路径
	public static String SWAGGER_TITLE="API文档-anxiaoguo"; 	    		//Swagger接口文档标题
